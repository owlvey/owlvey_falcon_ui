...
export class DetailReliabilityThreatComponent implements OnInit {
  ...
  constructor(
    ...
    onEditClick(event){
      ...
      this.router.navigate(['/pages/threats/reliability/edit'], extras);
    }
    onDeleteClick(event){
      if (window.confirm('Are you sure you want to delete?')) {
        this.riskGateway.deleteReliabilityThreat(this.threatId).subscribe(data=>{

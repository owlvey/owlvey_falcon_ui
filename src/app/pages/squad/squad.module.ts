...
@NgModule({
  declarations: [DetailSquadComponent, ListSquadComponent, CreateSquadComponent, EditSquadComponent, CreateUserSquadComponent, DetailUserSquadComponent, CreateProductSquadComponent, DetailProductSquadComponent],

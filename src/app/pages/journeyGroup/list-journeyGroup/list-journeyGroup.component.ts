...
@Component({
  selector: 'app-list-journeyGroup',
  templateUrl: './list-journeyGroup.component.html',
  styleUrls: ['./list-journeyGroup.component.scss']
})
export class ListJourneyGroupComponent extends ProductBaseComponent {
  constructor(
  ...
  onChangeQueryParameters(paramMap: ParamMap): void {
    ...
    this.journeysGateway.getPortfoliosGroup(this.productId, this.startDate, this.endDate).subscribe(data=>{
  ...
  onRowSelect(event){
    ...
    this.journeysGateway.getPortfoliosWithAvailabilities(this.productId, this.startDate, this.endDate, group).subscribe(portfolios=>{
    ...
    this.journeysGateway.getServicesDailyReport(this.productId, this.startDate, this.endDate, group).subscribe(data=>{

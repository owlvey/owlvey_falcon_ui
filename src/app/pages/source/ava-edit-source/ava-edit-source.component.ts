...
@Component({
  selector: 'app-ava-edit-source',
  templateUrl: './ava-edit-source.component.html',
  styleUrls: ['./ava-edit-source.component.scss']
})
export class AvaEditSourceComponent extends ProductBaseComponent {
  ...
  onSubmit() {
    ...
    let  defer = this.sourceGateway.putAvailabilitySource(this.sourceId, model);
